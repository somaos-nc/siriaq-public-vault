...
## Phase 1: Analytic Fisher Framework (Astrophysics)
**Reference:** *The Cherenkov Fisher Formula: An Analytic Sensitivity Estimator for UHECR LIV Searches (Halil Özbil, 2026)*

The theoretical origin of the framework lies in high-energy cosmic ray phenomenology. In searches for Lorentz Invariance Violation (LIV), the sensitivity of an experiment is dominated by the sharpness of the vacuum Cherenkov spectral edge. 

This work provided the first closed-form analytic expression for the Fisher information contributed by the Cherenkov edge:
$$F^{\text{Ch}}_{\alpha\alpha} = \frac{N_{\text{eff}}}{(n+2)^2 \alpha^2 \sigma_E^2}$$

**Core Insight:** The absolute sensitivity (the inverse of the Cramér-Rao Lower Bound, or CRLB) is governed by the structural integrity of the signal edge. Furthermore, the work introduced a geometric correction for "Pair-Production Broadening," establishing that physical noise and particle cascades fundamentally reduce the observable Fisher Information.

## Phase 2: Geometric Consistency Principles (Information Theory)
**Reference:** *LGC Geometric Information Loss Law and Pair-Production Broadening in LIV Phenomenology (Halil Özbil, 2026)*

The second phase generalized the specific astrophysical problem into a broader principle of Information Theory: the **Law of Geometric Consistency (LGC)**.
...
The final phase involved applying the geometric consistency loss to highly complex, stochastic biological systems—specifically, neurodegeneration in Alzheimer's disease.

This work introduced the **Özbil Score ($\Omega$)**, transforming the geometric information loss into a continuous, multimodal risk integration framework. By merging immediate neuroimaging evidence with longitudinal progression metrics and clinical modifiers, the Özbil Score provided a 0–100 scale for structural integrity.
